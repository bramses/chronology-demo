...
async def basic_example():
    prompt_summarize_for_a_2nd_grader = read_prompt(
...
async def basic_example_with_variables():
    ...
    prompt_summarize_for_a_2nd_grader_with_variables = read_prompt(
        "summarize_for_a_2nd_grader_with_variables")

    # use the Python3 `format()` method to replace {0} with our variables
    prompt_var_olive_oil = prompt_summarize_for_a_2nd_grader_with_variables.format(
        var_olive_oil)
    prompt_var_interior_design = prompt_summarize_for_a_2nd_grader_with_variables.format(
        var_interior_design)
...
async def logic():
    print(await basic_example())
    print(await basic_example_with_variables())
